...
' *  A Linked List implementation in Visual Basic
' *******************************************************
Namespace Lists.DoublyLinkedList
	...
	Public Class DoublyLinkedList(Of T As IComparable)
		''' <summary>
		...
		Public Class Node
			...
			Public Sub New(data1 As T)
				Data = data1
				Data = data1
				[Next] = InlineAssignHelper(Previous, Nothing)
			End Sub
		...
		Public Function Remove(data As T) As Node
			...
			If _head Is Nothing OrElse data Is Nothing Then
				Return Nothing
			End If
